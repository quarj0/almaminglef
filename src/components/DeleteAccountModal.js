  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-body">
        <p>Warning: Deleting your account is irreversible and all associated data will be permanently lost.</p>
      ...
      <div className="modal-footer">
        ...
        <button type="button" className="btn btn-primary" onClick={handleDeleteAccount}>Understood</button>
      </div>
    </div>
  </div>
</div>
